      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex gap-2 md:gap-2 mt-8 items-center">
              <a
                href="https://github.com/ecorkran"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GitHub"
                className="w-10 h-10 md:w-10 md:h-10 flex items-center justify-center rounded-[8px] bg-slate-900 border border-slate-600 text-slate-200 transition-all duration-200 ease-in-out hover:bg-slate-800 hover:border-slate-500 hover:text-white hover:scale-105"
              >
                {/* GitHub SVG */}
